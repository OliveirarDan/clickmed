			...
			<div class="row">
				<div class="col-lg-12">
					<form class="row contact_form" action="cadastraPaciente"
						method="post" id="cadastro" novalidate="">
						<div class="col-md-12">
							<div class="row">
							...
							<div class="row">
								...
								<div class="col-md-8">
									<label class="radio-inline" for="radios-0"> <input
										...
										type="radio" name="sexo" id="radios-2" value="3">
										Outro
									</label>
								</div>
							</div>
							<div class="row">
								...
								<div class="form-group col-md-2">
									<input type="number" class="single-input" id="cep" name="cep"
										placeholder="CEP" data-mask="00000000"
						...
						<div class="form-group">
							<input type="hidden" class="single-input" id="permissao" name="permissao"
								placeholder="Nome" value="paciente" required>
						</div>
