					...
					<div class="col-lg-12">
						<form class="row contact_form" action="salvaPaciente"
							...
							<div class="col-md-12">
									...
									<div class="col-md-8 col-6">
										...
										<div class="form-group">
											<input type="text" class="single-input" id="sobrenome"
												name="sobrenome" placeholder="Sobrenome" value="${paciente.sobrenome}" required />
										</div>
								...
								<div class="row">
									...
									<div class="form-group col-md-4">
										<input type="tel" class="single-input tel1"
											id="telresidencial" name="telefone1" value="${paciente.telefone1}"
											placeholder="Telefone residencial" required />
									</div>
									<div class="form-group col-md-4">
										<input type="tel" class="single-input tel2" id="telcelular" value="${paciente.telefone2}"
								...
								<div class="row">
									<div class="form-group col-md-8">
										<input type="text" class="single-input" id="rua" value="${paciente.nomeRua}"
											name="nomeRua" placeholder="Rua, Av, Logradouro" required />
									</div>
									<div class="form-group col-md-4">
							...
							<div class="col-md-12 text-center">
								<button type="submit" name="salvaPaciente"
