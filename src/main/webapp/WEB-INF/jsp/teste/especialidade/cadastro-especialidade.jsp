...
<body>
	...
	<section class="contact_area section_gap">
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-12">
					<form class="row contact_form" action="cadastraEspecialidade"
						...
						<div class="col-md-12">
							<div class="row">
								...
								<div class="col-md-12 text-center">
									<button type="submit" name="cadastraEspecialidade"
										value="cadastraEspecialidade" class="primary-btn text-uppercase">Cadastrar</button>
								</div>
							</div>
						</div>
					</form>
