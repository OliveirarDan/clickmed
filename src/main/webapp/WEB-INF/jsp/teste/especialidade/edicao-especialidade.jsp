...
<body>
	...
	<section class="contact_area section_gap">
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-12">
					<form class="row contact_form" action="salvaEspecialidade" method="post"
								...
								<div class="col-md-8 col-6">
									<div class="form-group">
										<input type="text" class="single-input" id="name" name="nome"
											placeholder="Nome" value="${especialidade.nome}" required />
									</div>
									<div class="form-group">
										<input type="hidden"
											class="single-input" id="id" name="id" value="${especialidade.id}" />
									</div>
								</div>
								<div class="col-md-12 text-center">
									<button type="submit" name="salvaEspecialidade"
										value="salvaEspecialidade" class="primary-btn text-uppercase">Salvar</button>
								</div>
							</div>
						</div>
					</form>
