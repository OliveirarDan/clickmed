		...
		<div class="container">
			<div class="page-content">
				...
				<div class="row">
					<div class="col-md-12">
						<span>
							<h3>Atualize os dados da sua clínica</h3>
						</span>
					</div>
				</div>
						...
						<form class="row contact_form" action="salvaClinica" method="post"
							...
							<div class="col-md-8">
								<div class="row">
									...
									<div class="form-group col-md-12 col-12">
										<input type="text" class="single-input" id="fantasia" value="${clinica.nomeFantasia}"
											name="nomeFantasia" placeholder="Nome Fantasia" required />
									</div>
								</div>
								<div class="row">
									<div class="form-group col-md-12 col-12">
										<input type="text" class="single-input" id="razao" value="${clinica.razaoSocial}"
											name="razaoSocial" placeholder="Razão Social" required />
									</div>
								</div>
								<div class="row">
									<div class="form-group col-md-6 col-12">
										<input type="text" class="single-input cnpj" id="cnpj" value="${clinica.cnpj}"
											name="cnpj" placeholder="CNPJ" required />
									</div>
									<div class="form-group col-md-6 col-12">
										<input type="email" class="single-input" id="email" value="${clinica.email}"
								...
								<div class="row">
									<div class="form-group col-md-6 col-12">
										<input type="tel" class="single-input tel1"
											id="telresidencial" name="telefone1" value="${clinica.telefone1}"
											placeholder="Telefone principal" required />
									</div>
									<div class="form-group col-md-6 col-12">
										<input type="tel" class="single-input tel1" id="telcelular" value="${clinica.telefone2}"
											name="telefone2" placeholder="Outro telefone" />
									</div>
								</div>
								<div class="row">
									<div class="form-group col-md-4 col-12">
										<input type="text" class="single-input cep" id="cep" value="${clinica.cep}" 
											name="cep" placeholder="CEP" required />
									</div>
								</div>
								<div class="row">
									<div class="form-group col-md-8">
										<input type="text" class="single-input" id="rua" name="rua" value="${clinica.rua}"
											placeholder="Rua, Av, Logradouro" required />
									</div>
									<div class="form-group col-md-4">
										<input type="text" class="single-input" id="numero" value="${clinica.numero}" 
											name="numero" placeholder="Nº" maxlength="5" required />
									</div>
								</div>
								<div class="row">
									<div class="form-group col-md-8">
										<input type="text" class="single-input" id="cidade" value="${clinica.cidade}"
							...
							<div class="col-md-4">
								...
								<div class="feature_head">
									<i class="fas fa-users"></i>
									<p>Acompanhe o crescimento da procura de seus
										profissionais.</p>
								</div>

							</div>
							<div class="col-md-12 text-center">
								<button type="submit" name="salvaClinica" value="salvaClinica"
